...
###Windows 设置
Internet 选项 -> 连接 选项卡 -> 局域网设置(如果是电脑拨号上网, 这里点“设置”) -> 使用自动配置脚本 -> 填入PAC地址 -> 确定
![pac1](http://tianti.io/images/pac-windows-1.png)

如果已经装有浏览器代理插件(如 SwitchyOmega/FoxyProxy)只要填上 PAC 地址或导入就可以了：
![pac2](http://tianti.io/images/pac-windows-2.png)

本地化用 PAC 文件方法: 首先，打开 PAC 文件地址，下载abc.pac文件到C盘根目录下，而本地PAC地址则为：file://C:/abc.pac
